...
function App() {
  ...
  try {
    ...
    const res = await axios.get(
      "https://project-intern-45n0.onrender.com/api/expenses"
    );
...
async function addTransaction() {
 ...
 async function deleteTransaction(id) {
  try {
    ...
    await axios.delete(
      `https://project-intern-45n0.onrender.com/api/expenses/${id}`
    );
  ...
  try {
    ...
    await axios.put(
      `https://project-intern-45n0.onrender.com/api/expenses/${editId}`,
      {
        food: Number(food),
